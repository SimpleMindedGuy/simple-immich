...
import type { TButtonLayout, TEventHandlerMap, TBaseButtonMapCollection, IBaseButtonMap } from "src/core/Abstract/element/trigger/iconButton";
import type { TBaseBooleanMap } from "src/core/Abstract/util/resolver/booleanResolver";
...
export type TAccount_Form_Conditions = "Hidden" | "External" | "Edit" | "Key";
/// define  boolean map
